namespace lambdaAttacks
{
    public partial class AttackForm : Form
    {
        ...
        public AttackForm()
        {
            ...
            this.rect1 = new Rectangle(10, 10, 1000, 550);
        ...
        {
            //this.attck.startAttacks((int)this.nValue.Value, (int)this.lambdaValue.Value, (int)this.mSystems.Value, (int)this.A.Value);
            this.attck.startAttacks(20, 10, 10, 4);
        }
